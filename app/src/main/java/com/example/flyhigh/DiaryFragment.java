...
public class DiaryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View mv = inflater.inflate(R.layout.fragment_diary, container, false);

        addNote = mv.findViewById(R.id.createNoteBtn);
        ...
        addNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), creatediary.class));
            }
        });
                ...
                popupbutton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        popupMenu.getMenu().add("Delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                            @Override
                            public boolean onMenuItemClick(MenuItem item) {
//                                Toast.makeText(v.getContext(), "Diary deleted", Toast.LENGTH_SHORT).show();
        ...
        mrecycleview = mv.findViewById(R.id.recyleView);
